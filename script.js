...
;(function () {
  ...
  const refs = [
    ...
    { src: 'assets/references/IMG_2617.png', alt: 'Referenca 6' },
    { src: 'assets/references/prinkraft.png', alt:'Referenca 7'},
    { src: 'assets/references/alius.png', alt: 'Referenca 8' }
  ]
  ...
  const start = () => {
    stop()
    timer = setInterval(() => slide(1), 2250)
  }
